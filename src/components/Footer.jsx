...
const Footer = () => {
  return (
    <footer className="pv4 ph2 tc-l">
      <a className="no-underline near-white bg-animate bg-near-black hover-bg-gray inline-flex items-center ma2 tc br2 pa2" href="https://github.com/alexticovschi" title="GitHub" target="_blank">
      ...
      <a className="no-underline near-white bg-animate bg-near-black hover-bg-gray inline-flex items-center ma2 tc br2 pa2" href="https://www.freecodecamp.org/alexticovschi" title="FreeCodeCamp" target="_blank">
        ...
        <span className="f6 ml3 pr2">FreeCodeCamp</span>
      </a>
      <a className="no-underline near-white bg-animate bg-near-black hover-bg-gray inline-flex items-center ma2 tc br2 pa2" href="https://linkedin.com" title="LinkedIn" target="_blank">
      ...
      <a className="no-underline near-white bg-animate bg-near-black hover-bg-gray inline-flex items-center ma2 tc br2 pa2" href="https://codepen.io/AlexTicovschi" title="CodePen" target="_blank">
